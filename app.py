...
with st.container(border= True):
    ...
    with col2 :
        d1 = {"normal": 0, "having ST-T wave abnormality": 1, "left ventrical hypertropy": 2}
        ...
        slope = d2[slope]
        num_vessels = st.selectbox("NUMBER OF VESSELS", options = [1,2,3,4])
        d3 = {"normal": 0, "fixed defect": 2, "reversable defect": 3}
